...
export function VideoCard({
    ...
    return (
        <Link
            href={link}
            className="block group tactical-card p-4 rounded-[20px] animate-in fade-in fill-mode-both"
        ...
        >
            ...
            <div className="flex justify-between items-start px-2">
                <div>
                    <h3 className="text-xl font-tactical font-bold mb-1 tracking-tight uppercase italic text-white">
                        {title}
                    </h3>
                    <p className="text-[10px] font-tactical opacity-30 uppercase text-white">
                        Creator: @{artist}
                    </p>
                </div>
                <button className="opacity-20 hover:opacity-100 transition-all text-white">
